...
| table_name                  | record_count | person_count |
| ---------------------- | -----------: | ------------------: |
...
| table_name | record_count | person_count |
| --- | --- | --- |
| condition_occurrence | 65,332 | 2,694 |
| drug_exposure | 67,707 | 2,694 |
| measurement | 44,053 | 2,686 |
| observation_period | 5,343 | 5,343 |
| person | 2,694 | 2,694 |
| visit_occurrence | 1,037 | 890 |
